...
import { verifyIfUserFollowsAnotherUser, createFollow, deleteFollow, countFollows } from "../controllers/followsControllers.js"

const router = Router();

router.get("/follows/:userId/:followerId", validateToken, validateIds, verifyIfUserFollowsAnotherUser);
router.get("/follows/:id", validateToken, validateUserId, countFollows);
