...
async function getHashtagPosts(hashtag){
    ...
    select hs."hashtagId" , h.name , p.article , p."urlImage" , p."urlDescription", u.username , u."pictureURL" ,p.url , p."urlTitle"  , hs."postId", u.id as "userId" 
    FROM hashtagsposts hs
